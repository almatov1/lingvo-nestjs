/*
  ...
  - The values [TASKS] on the enum `OnlineScreen` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "OnlineScreen_new" AS ENUM ('MENU', 'LEVELS', 'TOPICS', 'TASK');
