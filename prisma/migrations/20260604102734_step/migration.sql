/*
  ...
  - The values [LEVEL_RESULT] on the enum `Step` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Step_new" AS ENUM ('CHOOSE_LANGUAGE', 'REGISTRATION', 'PLACEMENT_TEST', 'LEARNING_FORMAT', 'LEARNING', 'COURSE_COMPLETE');
